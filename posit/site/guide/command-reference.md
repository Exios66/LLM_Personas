...
| `/aegis` | Invoke aegis-protocol subagent | Security, containment, ethical dilemma, crisis, meta-deliberation (See [Aegis-Protocol](/guide/aegis-protocol.html)) |
...
Details: [Domains-and-Experts](/guide/domains-and-experts.html) · [SME-Framework](/guide/sme-framework.html)
...
**See also:** [When-to-Convene](/guide/when-to-convene.html) · [Procedures](/guide/procedures.html)
