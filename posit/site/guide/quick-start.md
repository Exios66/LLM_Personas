...
5. **View transcripts in browser** — From the project root: `./portal/launch.sh`. Pick a deliberation; it opens in your default browser. See [Portal](/guide/portal.html).

6. **Save progress** — Use `/update` to checkpoint state and `/end` to close the session and finalize records.

***
**Next:** [The-Court](/guide/the-court.html) · [Command-Reference](/guide/command-reference.html) · [Procedures](/guide/procedures.html)
