...
| Goal | Page |
|------|------|
| Quick start steps | [Quick-Start](/guide/quick-start.html) |
| Court and commands | [The-Court](/guide/the-court.html) · [Command-Reference](/guide/command-reference.html) |
| When to convene | [When-to-Convene](/guide/when-to-convene.html) |
| Hand off to LIL_JEFF or OCTAVIUS | [Inter-Agent-Protocol](/guide/inter-agent-protocol.html) |
| SMEs | [Domains-and-Experts](/guide/domains-and-experts.html) |
| Glossary | [Glossary](/guide/glossary.html) |
| Troubleshooting | [Runbook](/guide/runbook.html) |
