...
- **Backup:** Before major sessions, copy `state/current.md` to `state/backups/YYYY-MM-DD-current.md`. See [Error-Recovery](/guide/error-recovery.html) and [Procedures](/guide/procedures.html).
...
**See:** [Error-Recovery](/guide/error-recovery.html) · [Procedures](/guide/procedures.html)
