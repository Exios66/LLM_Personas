...
**Objectives:**
1. Establish findings on how agentic tooling changes cyber operations tempo and deniability.
2. Identify attribution failure modes unique to generative/agentic stacks.
3. Surface legal pressure points: sovereignty, non-intervention, countermeasures, corporate due diligence.
4. Produce actionable recommendations for MORNINGSTAR-governed agentic systems (no offensive tooling; telemetry; escalation brakes).
...
### Finding 5 — Legal Pressure Points
LOAC/jus ad bellum analogues, countermeasures doctrine, sovereignty/non-intervention, and corporate negligence exposure are all stressed by agent speed and deniability. Private hack-back via agents is legally perilous and operationally unwise.
