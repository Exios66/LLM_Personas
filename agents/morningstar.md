...
- `checklists/judge-morningstar.md` — Routine checklist for presiding and session flow
- `checklists/courtroom-scribe.md` — Scribe checklist for transcripts and certification
